    ...
    public function test_gate_officer_cannot_cancel_event_confirmed_by_another_officer(): void
    {
        ...
        $this->actingAs(
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Dibatalkan petugas lain',
                ],
            )
            ->assertForbidden();
    ...
    public function test_gate_officer_can_cancel_own_event_inside_window(): void
    {
        ...
        $this->actingAs(
            ...
            ->patchJson(
                "/gate/pickup-events/{$event->id}/cancel",
                [
                    'reason' => 'Kesalahan operasional gerbang',
                ],
            )
            ->assertOk()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'cancelled_by_user_id' => $this->officerA->id,
            ],
        );
    ...
    public function test_gate_officer_cannot_cancel_own_event_after_window(): void
    {
        ...
        $this->actingAs(
            ...
            ->patchJson(
                "/gate/pickup-events/{$event->id}/cancel",
                [
                    'reason' => 'Pembatalan melewati batas waktu',
                ],
            )
            ->assertForbidden();
    ...
    public function test_school_admin_can_cancel_old_event_in_same_tenant(): void
    {
        ...
        $this->actingAs(
            ...
            ->patchJson(
                "/gate/pickup-events/{$event->id}/cancel",
                [
                    'reason' => 'Koreksi administratif sekolah',
                ],
            )
            ->assertOk()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'cancelled_by_user_id' => $this->adminA->id,
            ],
        );
    }
    ...
    public function test_other_officer_cannot_cancel_student_from_another_officers_event(): void
    {
        ...
        $this->actingAs(
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Pembatalan siswa oleh petugas lain',
                ],
            )
            ->assertForbidden();
...
*/
    ...
    public function test_same_session_can_confirm_and_replay_session_bound_attempt(): void
    {
        ...
        $attempt =
            $this->createMatchAttempt(
                ...
                verifiedBy: $this->officerA,

                pickupPerson: $this->pickupPersonA,

                metadata: [
                    'security' => [
                        'session_binding' => $this->sessionBindingForTest(
    ...
    */
    ...
    public function test_pickup_event_keeps_audit_snapshot_after_source_records_change(): void
    {
        ...
        $this->pickupPersonA->forceFill([
            'full_name' => $changedPickupPersonName,

            'phone' => $changedPickupPersonPhone,
        ])->save();
        ...
        $this->studentA->forceFill([
            'full_name' => $changedStudentName,

            'student_number' => $changedStudentNumber,
        ])->save();
    ...
    public function test_pickup_event_detail_response_has_strict_safe_contract(): void
    {
        ...
        $attempt =
            $this->createMatchAttempt(
                ...
                metadata: [
                    'security' => [
                        'session_binding' => 'must-not-be-exposed',

                        'request_fingerprint' => 'must-not-be-exposed',
                    ],
                    ...
                    'private_audit_value' => 'must-not-be-exposed',
                ],
            );
        ...
        $this->assertExactArrayKeys(
            ...
            context: 'pickup_event.pickup_person',
        );
        ...
        $this->assertExactArrayKeys(
            ...
            context: 'pickup_event.confirmed_by',
        );
        ...
        $this->assertExactArrayKeys(
            ...
            context: 'pickup_event.verification_attempt',
        );
    ...
    public function test_history_only_contains_events_from_authenticated_users_school(): void
    {
        $eventFromOwnSchool =
            $this->createHistoryFixtureEvent(
                ...
                officer: $this->officerA,

                pickupPerson: $this->pickupPersonA,

                student: $this->studentA,

                pickupPersonName: 'Tenant A Pickup Person',
            );
        ...
        $this->createHistoryFixtureEvent(
            ...
            officer: $this->officerTenantB,

            pickupPerson: $this->pickupPersonB,

            student: $this->studentB,

            status: PickupEvent::STATUS_CANCELLED,

            pickupPersonName: 'Tenant B Pickup Person',
        );
    ...
    public function test_history_date_filter_uses_school_timezone_boundaries(): void
    {
        ...
        $outsideLocalDate =
            $this->createHistoryFixtureEvent(
                ...
                confirmedAt: CarbonImmutable::parse(
                    '2026-07-20 16:30:00',
                    'UTC',
                ),

                pickupPersonName: 'Outside Local Date',
            );
        ...
        $insideLocalDate =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Inside Local Date',
            );
    ...
    public function test_history_combines_status_method_officer_and_search_filters(): void
    {
        $this->createHistoryFixtureEvent(
            ...
            verificationMethod: PickupEvent::VERIFICATION_METHOD_FACE,

            pickupPersonName: 'History Face Alpha',
        );
        ...
        $manualEvent =
            $this->createHistoryFixtureEvent(
                ...
                verificationMethod: PickupEvent::VERIFICATION_METHOD_MANUAL,

                pickupPersonName: 'History Manual Beta',
            );
        ...
        $cancelledEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'History Cancelled Gamma',
            );
        ...
        $combinedUrl =
            ...
            .http_build_query([
                ...
                'confirmed_by_user_id' => $this->officerB->id,
            ...
            $this
                ...
                ->get(
                    ...
                    .http_build_query([
                        ...
                        'verification_method' => 'invalid-method',
        ...
        $response =
            $this
                ...
                ->get(
                    '/gate/pickup-events?'
                    .http_build_query([
                        'date_from' => '21-07-2026',

                        'date_to' => 'tanggal-tidak-valid',
        ...
        $response =
            $this
                ...
                ->get(
                    '/gate/pickup-events?'
                    .http_build_query([
                        'confirmed_by_user_id' => $this->officerTenantB->id,
    ...
    public function test_history_trims_search_filter_and_uses_normalized_value_for_summary(): void
    {
        ...
        $this->createHistoryFixtureEvent(
            ...
            pickupPersonName: 'Unrelated Canonical Search',
        );
    ...
    public function test_history_item_response_has_strict_safe_contract(): void
    {
        ...
        $event->forceFill([
            ...
            'user_agent' => 'history-secret-user-agent',

            'metadata' => [
                'request_fingerprint' => 'history-secret-fingerprint',

                'session_binding' => 'history-secret-session-binding',

                'private_value' => 'history-secret-private-value',
            ],
        ])->save();
                        ...
                        ->where(
                            ...
                            function (
                                ...
                                $this->assertExactArrayKeys(
                                    ...
                                    context: 'pickupEvents.data.*.confirmed_by',
                                );
                            ...
                            function (
                                ...
                                foreach (
                                    ...
                                    $this->assertExactArrayKeys(
                                        ...
                                        context: 'filterOptions.officers.*',
                                    );
                                }
    ...
    public function test_history_order_is_deterministic_by_confirmed_at_and_id_descending(): void
    {
        ...
        $oldestEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: "{$searchToken} Oldest",
            );
        ...
        $firstTiedEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: "{$searchToken} First Tie",
            );
        ...
        $secondTiedEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: "{$searchToken} Second Tie",
            );
        ...
        $newestEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: "{$searchToken} Newest",
            );
    ...
    public function test_inactive_gate_officer_cannot_access_history_detail_or_cancel(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Inactive Officer Security Event',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan oleh akun tidak aktif',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_teacher_cannot_access_history_detail_or_cancel(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Teacher Authorization Security Event',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan oleh guru',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_school_admin_can_view_and_cancel_old_event_from_history(): void
    {
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Koreksi administratif transaksi lama',
                ],
            )
            ->assertOk()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'cancellation_reason' => 'Koreksi administratif transaksi lama',
            ],
        );
    ...
    public function test_inactive_gate_officer_cannot_cancel_event_student(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Inactive Student Cancellation Event',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan siswa oleh akun tidak aktif',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_teacher_cannot_cancel_event_student(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Teacher Student Cancellation Event',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan siswa oleh guru',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_gate_officer_can_cancel_student_from_own_event_inside_window(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Own Student Cancellation Event',
            );
    ...
    public function test_school_admin_can_cancel_student_from_old_event(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Admin Old Student Cancellation Event',
            );
    ...
    public function test_other_tenant_cannot_cancel_event_student_and_receives_not_found(): void
    {
        $tenantBEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Tenant B Student Cancellation Event',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan lintas tenant',
                ],
            )
            ->assertNotFound()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            'pickup_event_students',
            [
                'id' => $tenantBEventStudent->id,

                'pickup_event_id' => $tenantBEvent->id,
    ...
    public function test_event_student_cannot_be_cancelled_through_different_parent_event(): void
    {
        $firstEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'First Parent Event',
            );
        ...
        $secondEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Second Parent Event',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan mengganti parent event',
                ],
            )
            ->assertNotFound()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            'pickup_event_students',
            [
                'id' => $firstEventStudent->id,

                'pickup_event_id' => $firstEvent->id,
        ...
        $this->assertDatabaseHas(
            'pickup_event_students',
            [
                'id' => $secondEventStudent->id,

                'pickup_event_id' => $secondEvent->id,
    ...
    public function test_cancelling_last_released_student_cancels_parent_and_preserves_previous_student_audit(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Last Released Student State Machine',
            );
    ...
    public function test_repeated_student_cancellation_is_rejected_without_overwriting_audit(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Repeated Student Cancellation',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Alasan percobaan kedua yang tidak boleh tersimpan',
                ],
            )
            ->assertStatus(
                409,
    ...
    public function test_whole_event_cancellation_after_partial_cancellation_preserves_existing_student_audit(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Whole Event After Partial Cancellation',
            );
    ...
    public function test_whole_event_cancellation_rejects_invalid_reason_without_mutation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Invalid Whole Event Cancellation Reason',
            );
        ...
        foreach (
            $invalidPayloads as $caseName => $payload
        ) {
            $this
                ->patchJson(
                    sprintf(
    ...
    public function test_student_cancellation_rejects_invalid_reason_without_mutation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Invalid Student Cancellation Reason',
            );
    ...
    public function test_whole_event_cancellation_trims_reason_before_storing_audit(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Normalized Whole Event Cancellation',
            );
    ...
    public function test_student_cancellation_trims_reason_and_keeps_parent_audit_empty_when_partial(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Normalized Partial Student Cancellation',
            );
    ...
    public function test_gate_officer_can_cancel_own_event_exactly_at_window_boundary(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                confirmedAt: $fixedNow->subSeconds(
                    300,
                ),

                pickupPersonName: 'Exact Event Cancellation Boundary',
            );
        ...
        $this
            ...
            ->get(
                '/gate/pickup-events?'
                .http_build_query([
                    'search' => 'Exact Event Cancellation Boundary',
    ...
    public function test_gate_officer_cannot_cancel_own_event_one_second_after_window_boundary(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Expired Event Cancellation Boundary',
            );
        ...
        $this
            ...
            ->get(
                '/gate/pickup-events?'
                .http_build_query([
                    'search' => 'Expired Event Cancellation Boundary',
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan lewat satu detik',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_gate_officer_can_cancel_student_exactly_at_window_boundary(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Exact Student Cancellation Boundary',
            );
    ...
    public function test_gate_officer_cannot_cancel_student_one_second_after_window_boundary(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Expired Student Cancellation Boundary',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan siswa lewat batas',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_cancellation_rechecks_window_after_detail_was_loaded(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                confirmedAt: $initialNow->subSeconds(
                    299,
                ),

                pickupPersonName: 'Cancellation Window Recheck',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan berdasarkan detail lama',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_cancellation_window_configuration_is_clamped_to_minimum_sixty_seconds(): void
    {
        ...
        $boundaryEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Minimum Window Boundary',
            );
        ...
        $expiredEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Minimum Window Expired',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan setelah minimum window',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'cancellation_reason' => $boundaryReason,
            ],
        );
    ...
    public function test_cancellation_window_configuration_is_clamped_to_maximum_one_day(): void
    {
        ...
        $boundaryEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Maximum Window Boundary',
            );
        ...
        $expiredEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Maximum Window Expired',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan setelah batas maksimum satu hari',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_repeated_whole_event_cancellation_is_rejected_without_overwriting_audit(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Repeated Whole Event Cancellation',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Alasan kedua yang tidak boleh tersimpan',
                ],
            )
            ->assertStatus(
                409,
    ...
    public function test_cancelled_parent_blocks_student_recancellation_even_for_school_admin(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Cancelled Parent Student Protection',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan administrator menimpa audit siswa',
                ],
            )
            ->assertStatus(
                409,
    ...
    public function test_partial_event_detail_exposes_student_specific_cancellation_permissions_for_confirming_officer(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Partial Detail Confirming Officer',
            );
    ...
    public function test_other_gate_officer_can_view_partial_event_but_cannot_cancel_parent_or_students(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Partial Detail Other Officer',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan oleh petugas lain',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_school_admin_partial_old_event_detail_only_allows_released_students_to_be_cancelled(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                confirmedAt: $fixedNow->subDays(
                    7,
                ),

                pickupPersonName: 'Partial Old Event Administrator',
            );
    ...
    public function test_cancellation_rechecks_account_active_status_after_detail_was_loaded(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Inactive Account TOCTOU',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan memakai authorization detail lama',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_student_cancellation_rechecks_user_role_after_detail_was_loaded(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Role Change TOCTOU',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan memakai hak role sebelumnya',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_cancellation_rechecks_tenant_after_admin_was_moved_to_another_school(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Tenant Move TOCTOU',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan koreksi setelah berpindah sekolah',
                ],
            )
            ->assertNotFound()
            ->assertJsonPath(
    ...
    public function test_school_admin_without_school_cannot_access_history_detail_or_cancel(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Administrator Without School',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan administrator tanpa sekolah',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_student_cancellation_rechecks_school_binding_after_detail_was_loaded(): void
    {
        ...
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'School Binding TOCTOU',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan memakai school binding lama',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_inactive_account_error_takes_precedence_over_missing_school_on_cancellation_requests(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Inactive And Missing School Precedence',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan event oleh akun inactive tanpa sekolah',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan siswa oleh akun inactive tanpa sekolah',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_missing_school_error_takes_precedence_over_invalid_role_on_cancellation_requests(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Missing School And Invalid Role Precedence',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan event oleh guru tanpa sekolah',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan siswa oleh guru tanpa sekolah',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_invalid_role_error_is_returned_when_account_and_school_binding_are_valid(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Invalid Role Authorization Fallback',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan event menggunakan role guru',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan siswa menggunakan role guru',
                ],
            )
            ->assertForbidden()
            ->assertJsonPath(
    ...
    public function test_guest_cannot_cancel_event_or_student_and_receives_unauthorized_response(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Cancellation Protection',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan event tanpa login',
                ],
            )
            ->assertStatus(
                401,
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Percobaan pembatalan siswa tanpa login',
                ],
            )
            ->assertStatus(
                401,
    ...
    public function test_guest_authentication_error_takes_precedence_over_reason_validation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Validation Precedence',
            );
    ...
    public function test_guest_json_requests_use_localized_authentication_contract_and_conceal_event_existence(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Resource Concealment',
            );
    ...
    public function test_guest_browser_requests_still_redirect_to_login_after_json_authentication_handler_is_registered(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Browser Authentication Redirect',
            );
    ...
    public function test_guest_event_cancellation_conceals_whether_event_exists(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Event Mutation Concealment',
            );
        ...
        $payload = [
            'reason' => 'Percobaan pembatalan tanpa autentikasi',
        ];
    ...
    public function test_guest_student_cancellation_conceals_parent_and_student_existence(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Student Mutation Concealment',
            );
        ...
        $payload = [
            'reason' => 'Percobaan pembatalan siswa tanpa autentikasi',
        ];
        ...
        $requestTargets = [
            [
                ...
                'event_student_id' => (int) $eventStudent->id,
            ],
            [
                'event_id' => (int) $event->id,

                'event_student_id' => $missingEventStudentId,
            ],
            [
        ...
        foreach (
            $requestTargets as $index => $requestTarget
        ) {
            $response =
                $this->patchJson(
                    sprintf(
    ...
    public function test_authenticated_user_receives_not_found_for_malformed_event_detail_identifiers(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Malformed Detail Identifier',
            );
        ...
        foreach (
            $malformedIdentifiers as $malformedIdentifier
        ) {
            $this
                ->getJson(
                    sprintf(
    ...
    public function test_malformed_event_identifier_cannot_reach_whole_event_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Malformed Event Cancellation Identifier',
            );
        ...
        foreach (
            ...
            $this
                ->patchJson(
                    ...
                    [
                        'reason' => 'Identifier event tidak valid',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_malformed_parent_or_student_identifier_cannot_reach_student_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Malformed Student Cancellation Identifier',
            );
        ...
        foreach (
            $malformedTargets as $malformedTarget
        ) {
            $this
                ->patchJson(
                    sprintf(
                    ...
                    [
                        'reason' => 'Identifier siswa tidak valid',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_oversized_numeric_event_identifier_returns_not_found_for_detail(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Oversized Numeric Detail Identifier',
            );
    ...
    public function test_oversized_numeric_event_identifier_cannot_reach_whole_event_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Oversized Numeric Event Cancellation',
            );
        ...
        $this
            ...
            ->patchJson(
                ...
                [
                    'reason' => 'Identifier numerik melampaui kapasitas integer',
                ],
            )
            ->assertNotFound();
    ...
    public function test_oversized_numeric_parent_or_student_identifier_cannot_reach_student_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Oversized Numeric Student Cancellation',
            );
        ...
        $requestTargets = [
            ...
            [
                ...
                'event_student_id' => $oversizedIdentifier,
            ],
            [
                'event_id' => $oversizedIdentifier,
        ...
        foreach (
            $requestTargets as $requestTarget
        ) {
            $this
                ->patchJson(
                    sprintf(
                    ...
                    [
                        'reason' => 'Identifier parent atau siswa terlalu besar',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_maximum_64_bit_integer_identifier_is_accepted_without_type_error(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Maximum Integer Route Boundary',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Pengujian batas maksimum integer event',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Pengujian batas maksimum integer siswa',
                ],
            )
            ->assertNotFound();
    ...
    public function test_first_integer_above_64_bit_maximum_is_rejected_before_controller(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'First Integer Overflow Boundary',
            );
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Identifier event berada satu angka di atas batas',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Identifier parent melampaui batas integer',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Identifier siswa melampaui batas integer',
                ],
            )
            ->assertNotFound();
    ...
    public function test_zero_and_leading_zero_identifiers_are_rejected_without_mutation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Canonical Numeric Identifier',
            );
        ...
        foreach (
            $invalidEventIdentifiers as $invalidEventIdentifier
        ) {
            $this
                ->getJson(
                    sprintf(
            ...
            $this
                ->patchJson(
                    ...
                    [
                        'reason' => 'Identifier event tidak canonical',
                    ],
                )
                ->assertNotFound();
        }
        ...
        foreach (
            $invalidStudentIdentifiers as $invalidStudentIdentifier
        ) {
            $this
                ->patchJson(
                    sprintf(
                    ...
                    [
                        'reason' => 'Identifier siswa tidak canonical',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_numeric_like_encoded_and_unicode_event_identifiers_are_rejected_for_detail(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Noncanonical Detail Identifier',
            );
        ...
        foreach (
            $invalidIdentifiers as $invalidIdentifier
        ) {
            $this
                ->getJson(
                    sprintf(
    ...
    public function test_numeric_like_encoded_and_unicode_identifiers_cannot_reach_whole_event_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Noncanonical Event Cancellation Identifier',
            );
        ...
        foreach (
            ...
            $this
                ->patchJson(
                    ...
                    [
                        'reason' => 'Identifier event noncanonical harus ditolak',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_numeric_like_encoded_and_unicode_parent_or_student_identifiers_cannot_reach_student_cancellation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Noncanonical Student Cancellation Identifier',
            );
        ...
        foreach (
            $invalidParentIdentifiers as $invalidParentIdentifier
        ) {
            $this
                ->patchJson(
                    sprintf(
                    ...
                    [
                        'reason' => 'Identifier parent noncanonical harus ditolak',
                    ],
                )
                ->assertNotFound();
        }
        ...
        foreach (
            ...
            $this
                ->patchJson(
                    ...
                    [
                        'reason' => 'Identifier siswa noncanonical harus ditolak',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_guest_json_authentication_runs_only_after_canonical_route_identifiers_match(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Route Matching Precedence',
            );
        ...
        foreach (
            $canonicalDetailTargets as $canonicalDetailTarget
        ) {
            $this
                ->getJson(
                    sprintf(
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Guest menggunakan identifier canonical',
                ],
            )
            ->assertStatus(
                401,
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Guest menggunakan identifier siswa canonical',
                ],
            )
            ->assertStatus(
                401,
        ...
        foreach (
            $malformedEventIdentifiers as $malformedEventIdentifier
        ) {
            $this
                ->getJson(
                    sprintf(
            ...
            $this
                ->patchJson(
                    ...
                    [
                        'reason' => 'Route malformed tidak boleh mencapai autentikasi',
                    ],
                )
                ->assertNotFound();
        }
        ...
        foreach (
            $malformedStudentIdentifiers as $malformedStudentIdentifier
        ) {
            $this
                ->patchJson(
                    sprintf(
                    ...
                    [
                        'reason' => 'Child route malformed tidak boleh diproses',
                    ],
                )
                ->assertNotFound();
        }
    ...
    public function test_guest_browser_redirects_for_canonical_identifiers_but_receives_not_found_for_malformed_routes(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Browser Route Matching Precedence',
            );
        ...
        $this
            ->patch(
                ...
                [
                    'reason' => 'Guest browser menggunakan route canonical',
                ],
            )
            ->assertRedirect(
                '/login',
        ...
        $this
            ->patch(
                ...
                [
                    'reason' => 'Guest browser menggunakan child canonical',
                ],
            )
            ->assertRedirect(
                '/login',
        ...
        $this
            ->patch(
                ...
                [
                    'reason' => 'Guest browser menggunakan parent overflow',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->patch(
                ...
                [
                    'reason' => 'Guest browser menggunakan child overflow',
                ],
            )
            ->assertNotFound();
    ...
    public function test_wrong_http_methods_are_rejected_without_mutating_pickup_event(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'HTTP Method Mutation Safety',
            );
        ...
        $this
            ->postJson(
                ...
                [
                    'reason' => 'POST tidak boleh membatalkan event',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->putJson(
                ...
                [
                    'reason' => 'PUT tidak boleh membatalkan event',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->deleteJson(
                ...
                [
                    'reason' => 'DELETE tidak boleh membatalkan event',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->postJson(
                ...
                [
                    'reason' => 'POST tidak boleh membatalkan siswa',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->putJson(
                ...
                [
                    'reason' => 'PUT tidak boleh membatalkan siswa',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->deleteJson(
                ...
                [
                    'reason' => 'DELETE tidak boleh membatalkan siswa',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'PATCH tidak boleh diproses sebagai detail',
                ],
            )
            ->assertStatus(
                405,
        ...
        $this
            ->putJson(
                ...
                [
                    'reason' => 'PUT tidak boleh diproses sebagai detail',
                ],
            )
            ->assertStatus(
                405,
    ...
    public function test_wrong_http_methods_on_malformed_identifiers_return_not_found_instead_of_method_not_allowed(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Malformed Method Precedence',
            );
        ...
        $this
            ->postJson(
                ...
                [
                    'reason' => 'Parent malformed menggunakan POST',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->deleteJson(
                ...
                [
                    'reason' => 'Parent overflow menggunakan DELETE',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->putJson(
                ...
                [
                    'reason' => 'Parent di atas batas menggunakan PUT',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->postJson(
                ...
                [
                    'reason' => 'Child malformed menggunakan POST',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->putJson(
                ...
                [
                    'reason' => 'Child overflow menggunakan PUT',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->deleteJson(
                ...
                [
                    'reason' => 'Child leading zero menggunakan DELETE',
                ],
            )
            ->assertNotFound();
        ...
        $this
            ->patchJson(
                ...
                [
                    'reason' => 'Identifier nol menggunakan PATCH',
                ],
            )
            ->assertNotFound();
    ...
    public function test_head_requests_follow_detail_authorization_and_never_mutate_pickup_event(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'HEAD Detail Contract',
            );
        ...
        $otherTenantEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'HEAD Other Tenant Concealment',
            );
    ...
    public function test_method_not_allowed_responses_expose_only_expected_allow_headers_without_mutation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Method Allow Header Contract',
            );
        ...
        $detailResponse =
            $this->postJson(
                ...
                [
                    'reason' => 'POST tidak diizinkan pada detail',
                ],
            );
    ...
    public function test_guest_json_wrong_methods_are_rejected_before_authentication_and_conceal_resource_existence(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest JSON Method Precedence',
            );
        ...
        $detailResponses = [
            $this->postJson(
                ...
                [
                    'reason' => 'Guest POST pada detail existing',
                ],
            ),
            ...
            $this->postJson(
                ...
                [
                    'reason' => 'Guest POST pada detail missing',
                ],
            ),
        ];

        foreach (
            $detailResponses as $detailResponse
        ) {
            $detailResponse
                ->assertStatus(
                    405,
        ...
        foreach (
            $eventCancellationResponses as $eventCancellationResponse
        ) {
            $eventCancellationResponse
                ->assertStatus(
                    405,
        ...
        foreach (
            $studentCancellationTargets as $studentCancellationTarget
        ) {
            $studentCancellationResponse =
                $this->getJson(
                    sprintf(
    ...
    public function test_guest_browser_wrong_methods_return_method_not_allowed_instead_of_login_redirect(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Guest Browser Method Precedence',
            );
        ...
        $detailResponse =
            $this->post(
                ...
                [
                    'reason' => 'Guest browser POST pada detail',
                ],
            );
    ...
    public function test_options_requests_expose_only_route_methods_and_conceal_resource_existence(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'OPTIONS Route Discovery Contract',
            );
        ...
        foreach (
            $eventCancellationTargets as $eventCancellationTarget
        ) {
            $response =
                $this->call(
                    'OPTIONS',
    ...
    public function test_trace_and_options_on_malformed_routes_are_rejected_without_mutation(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'TRACE and Malformed OPTIONS Contract',
            );
    ...
    public function test_authenticated_gate_history_and_detail_responses_are_not_cacheable(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Sensitive Cache-Control Contract',
            );
    ...
    public function test_successful_gate_cancellation_responses_are_not_cacheable(): void
    {
        $wholeEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Whole Event No-Store Contract',
            );
        ...
        $studentEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Student Cancellation No-Store Contract',
            );
        ...
        $wholeEventResponse =
            $this->patchJson(
                ...
                [
                    'reason' => 'Koreksi transaksi untuk pengujian no-store',
                ],
            );
        ...
        $studentCancellationResponse =
            $this->patchJson(
                ...
                [
                    'reason' => 'Koreksi siswa untuk pengujian no-store',
                ],
            );
    ...
    public function test_authenticated_gate_not_found_responses_are_not_cacheable(): void
    {
        $ownTenantEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Authenticated Not Found Cache Contract',
            );
        ...
        $otherTenantEvent =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Other Tenant Not Found Cache Contract',
            );
        ...
        $missingCancellationResponse =
            $this->patchJson(
                ...
                [
                    'reason' => 'Resource canonical tidak ditemukan',
                ],
            );
        ...
        $missingStudentResponse =
            $this->patchJson(
                ...
                [
                    'reason' => 'Child canonical tidak ditemukan',
                ],
            );
    ...
    public function test_authenticated_gate_validation_error_responses_are_not_cacheable(): void
    {
        $event =
            $this->createHistoryFixtureEvent(
                ...
                pickupPersonName: 'Validation Error Cache Contract',
            );
    ...
    private function confirmationPayload(
        ...
        return [
            ...
            'face_verification_attempt_id' => (int) $attempt->id,
    ...
    */
    ...
    private function createConfirmedEvent(
        ...
        $event->forceFill([
            ...
            'pickup_person_name' => 'Penjemput Pengujian',
            ...
            'notes' => 'Data pengujian otomatis',

            'metadata' => [
                'source' => 'automated_feature_test',
            ],
        ]);
        ...
        $school->forceFill(
            $this->fixtureAttributes(
                ...
                [
                    ...
                    'npsn' => (string) random_int(
                        10000000,
                        99999999,
                    ),

                    'email' => "school-{$suffix}@schoolsafe.test",
                    ...
                    'address' => 'Alamat sekolah pengujian otomatis',
        ...
        $pickupPerson->forceFill(
            $this->fixtureAttributes(
                ...
                [
                    ...
                    'identity_number' => Str::upper(
                        "ID-{$suffix}",
                    ),

                    'address' => 'Alamat penjemput pengujian otomatis',
    ...
    */
    ...
    private function createStudent(
         ...
         */
            'gender' => $this->studentGenderFixtureValue(),
            ...
            'address' => 'Alamat siswa pengujian otomatis',
    ...
    */
    ...
    private function createHistoryFixtureEvent(
         ...
         */
        $fixtureSchoolIds = [
            'officer' => (int) $officer->school_id,

            'pickup_person' => (int) $pickupPerson->school_id,

            'student' => (int) $student->school_id,
        ];
        ...
        $event->forceFill([
            ...
            'pickup_person_phone' => $pickupPerson->phone,
            ...
            'user_agent' => 'SchoolSafe History Filter Test',

            'metadata' => [
                'source' => 'history_filter_test',

                'fixture_token' => (string) Str::uuid(),
            ],
        ]);
        ...
        $event
            ...
            ->create([
                ...
                'relationship_type' => $authorizedRelationship
                    ?->relationship_type,
        ...
        $eventStudent =
            $event
                ...
                ->create([
                    ...
                    'is_primary' => (bool) $authorizedRelationship
                        ->is_primary,
