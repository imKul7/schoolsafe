...
export function AppSidebar() {
    ...
    return (
        <Sidebar
            collapsible="icon"
            variant="inset"
            className="border-r border-[#e6eef5] bg-[#fbfdff]"
        >
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton
                            size="lg"
                            asChild
                            className="rounded-2xl transition-colors hover:bg-[#eef6ff]"
                        >
        ...
        <SidebarMenu className="gap-1">
            ...
            <SidebarFooter className="border-t border-[#edf2f7] p-2">
                <div className="mx-1 mb-2 rounded-2xl border border-[#dceaf5] bg-gradient-to-br from-[#eef7fc] to-[#eef9f6] p-3 text-xs group-data-[collapsible=icon]:hidden">
                    ...
                    <p className="leading-relaxed text-[#627d98]">
                        Seluruh aktivitas penjemputan tercatat dan dapat
