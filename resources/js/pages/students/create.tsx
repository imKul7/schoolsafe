            ...
            <main className="min-h-full bg-[#f8fafc]">
                <div className="mx-auto w-full max-w-5xl p-4 md:p-6">
                        ...
                        <div className="relative flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 max-w-2xl text-sm leading-6 text-[#627d98]">
                                    Lengkapi identitas dan informasi akademik
                                    siswa yang akan didaftarkan ke SchoolSafe.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    {classes.length === 0 && (
                        <section
                            role="alert"
                            className="mb-6 rounded-2xl border border-[#f1dfae] bg-[#fff8df] p-5"
                        >
                            <div className="flex items-start gap-3">
                                <AlertCircle className="mt-0.5 size-5 shrink-0 text-[#b88a22]" />

                                <div>
                                    <h2 className="font-semibold text-[#7d5d18]">
                                        Belum ada kelas aktif
                                    </h2>

                                    <p className="mt-1 text-sm leading-6 text-[#99752b]">
                                        Data siswa belum dapat disimpan karena
                                        sekolah belum memiliki kelas aktif.
                                    </p>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="mb-6 flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#829ab1]">
                                        Informasi dasar dan identitas resmi
                                        siswa.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-5 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 flex items-start justify-between gap-3">
                                        ...
                                        <span className="ml-auto text-xs text-[#9fb3c8]">
                                            {data.nisn.length}/10
                                        </span>
                                    </div>
                                </div>
