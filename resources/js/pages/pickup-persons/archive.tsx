...
export default function PickupPersonArchive({
    pickupPersons,
    filters,
}: PickupPersonArchiveProps) {
    ...
    const isProcessing = (
        ...
        processingState.id === pickupPersonId &&
        processingState.action === action;

    const submitSearch: FormEventHandler<
        HTMLFormElement
    > = (event) => {
    ...
    const restorePickupPerson = (
        pickupPerson: ArchivedPickupPerson,
    ): void => {
        const confirmed = window.confirm(
            `Pulihkan data ${pickupPerson.full_name} dari arsip?`,
        );
    ...
    const forceDeletePickupPerson = (
        ...
        router.delete(
            `/pickup-persons/archive/${pickupPerson.id}/force-delete`,
            {
                preserveScroll: true,
                ...
                <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-6 p-4 md:p-6">
                    ...
                    <section className="relative overflow-hidden rounded-[28px] border border-[#eadfcb] bg-gradient-to-r from-[#fff8eb] via-[#fffaf4] to-[#f5f8fc] p-6 shadow-sm md:p-8">
                        ...
                        <div className="relative flex flex-col justify-between gap-5 md:flex-row md:items-center">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#a18a5f]">
                                        Data Penjemput
                                    </p>

                                    <h1 className="mt-1 text-2xl font-bold tracking-tight text-[#243b53] md:text-3xl">
                                        Arsip Penjemput
                                    </h1>

                                    <p className="mt-2 max-w-2xl text-sm leading-6 text-[#627d98]">
                                        Kelola data penjemput yang
                                        telah diarsipkan. Data dapat
                                        dipulihkan atau dihapus secara
                                        permanen.
                                    </p>
                                </div>
                            </div>
                    ...
                    <section className="rounded-2xl border border-[#efd7d7] bg-[#fff6f6] p-4 shadow-sm">
                        <div className="flex items-start gap-3">
                            <AlertTriangle
                                aria-hidden="true"
                                className="mt-0.5 size-5 shrink-0 text-[#c45d5d]"
                            />
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-[#b46363]">
                                    Hapus permanen tidak dapat
                                    dibatalkan. Gunakan fitur tersebut
                                    hanya ketika data benar-benar tidak
                                    diperlukan lagi.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="rounded-2xl border border-[#e6eef5] bg-white p-5 shadow-sm">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm leading-6 text-[#829ab1]">
                                Cari berdasarkan nama, identitas,
                                nomor telepon, atau email penjemput.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col justify-between gap-2 border-b border-[#edf2f7] px-5 py-4 sm:flex-row sm:items-center">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-[#829ab1]">
                                    Data penjemput yang telah dipindahkan
                                    dari daftar utama.
                                </p>
                            </div>
                        ...
                        {pickupPersons.data.length > 0 ? (
                            <>
                                ...
                                <div className="flex flex-col justify-between gap-4 border-t border-[#edf2f7] px-5 py-4 sm:flex-row sm:items-center">
                                    ...
                                    <nav
                                        aria-label="Navigasi halaman arsip penjemput"
