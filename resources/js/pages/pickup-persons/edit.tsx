...
interface PickupPersonStudentPayload {
...
interface EditablePickupPerson {
    id: number;
    full_name: string;
    ...
    is_active: boolean;
    notes: string | null;
    students: PickupPersonStudentPayload[];
}

interface EditPickupPersonProps {
    pickupPerson: EditablePickupPerson;
                ...
                <div className="mx-auto w-full max-w-6xl p-4 md:p-6">
                    ...
                    <section className="relative mb-6 overflow-hidden rounded-[28px] border border-[#deebf5] bg-gradient-to-r from-[#edf6ff] via-[#f2faf8] to-[#fffaf0] p-6 shadow-sm md:p-8">
                        ...
                        <div className="relative flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
                            ...
                            {isDirty && (
                                <span className="inline-flex w-fit rounded-full border border-[#f0dfb6] bg-[#fff8e8] px-3 py-1.5 text-xs font-semibold text-[#9a741f]">
