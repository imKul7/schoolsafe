...
export default function Login({
    ...
    return (
        <AuthLayout
            ...
            description="Masukkan akun sekolah Anda untuk mengakses sistem penjemputan SchoolSafe."
        >
            <Head title="Masuk" />
            ...
            >
                ...
                <div>
                    <div className="mb-2 flex items-center justify-between gap-4">
                        <label
                            htmlFor="password"
                            className="text-sm font-semibold text-[#334e68]"
                        >
                            Kata sandi
                        </label>
                        ...
                        {canResetPassword && (
                            <Link
                                ...
                                className="text-xs font-semibold text-[#4f7cac] transition-colors hover:text-[#37658f] hover:underline focus-visible:rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#dcebf8]"
                            >
                                Lupa kata sandi?
                            </Link>
                        )}
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="absolute top-1/2 right-3.5 flex size-8 -translate-y-1/2 items-center justify-center rounded-lg text-[#9fb3c8] transition-colors hover:bg-[#eef6ff] hover:text-[#4f7cac] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#dcebf8] disabled:cursor-not-allowed disabled:opacity-60"
                        >
                            {showPassword ? (
                                <EyeOff
                                    aria-hidden="true"
                ...
                >
                    ...
                    <span className="select-none text-sm text-[#627d98]">
            ...
            <div className="mt-7 flex items-center gap-3">
                ...
                <span className="whitespace-nowrap text-xs text-[#9fb3c8]">
                    Sistem penjemputan aman
                </span>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-[#829ab1]">
                            Gunakan akun resmi yang telah diberikan oleh
                            administrator sekolah. Jangan membagikan kata
                            sandi kepada orang lain.
                        </p>
                    </div>
                </div>
            </div>
